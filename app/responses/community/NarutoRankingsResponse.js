...
module.exports = class NarutoRankingsResponse extends ServerResponse {
  ...
  run(client, message) {
    message.build(
      message.flyReply("Com dúvidas sobre o FlyHigh? Pegue o cargo <@&643566203503378454> no <#702147947978293310> para obter acesso ao canal de Dúvidas Frequentes.", "828360658159927316"),
