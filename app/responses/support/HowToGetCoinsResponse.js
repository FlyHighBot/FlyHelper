...
module.exports = class HowToGetCoinsResponse extends ServerResponse {
  ...
  async run(client, message) {
    message.build(
      message.flyReply("você pode ganhar **Fly Coins**.... Dormindo! Ksksks brincadeirinha! Existe uma maneira muito simples de ganhar **Fly Coins**, apenas coletando daily!", "826430254084128829"),
