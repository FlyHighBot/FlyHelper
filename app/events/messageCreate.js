module.exports = async (client, message) => {
  ...
  message.guild.type = type, client.owner = client.users.cache.get(""), client.guild = client.guilds.cache.get(""), client.support = client.guilds.cache.get(""), client.prefix = process.env.PREFIX
